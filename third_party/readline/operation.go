...
func (o *operation) readline(deadline chan struct{}) ([]rune, error) {
	...
	for {
		...
		switch r {
		case CharEsc:
			// Ultima patch: bare Escape outside vim mode (see the
			// consumeANSIEscape patch in terminal.go); ignore it instead of
			// inserting a control character into the buffer.
		case CharBell:
